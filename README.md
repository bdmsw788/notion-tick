...
6. **対話型伝道プレゼンテーション「福音ナビゲーター」 (`gospel_navigator.html`)**
   - 相手に合わせて（虹の架け橋 / 4つの法則 / お悩み別 / 3分クイック）スマホで一緒に画面を見ながら神様の愛を伝えられるモバイルツール。
   - 動く図解（心の王座・いのちの架け橋）、話者用カンペ（ナビゲーターメモ）、初心者向け豆知識・Q&A辞書を完備。
